...
<?php echo form_open('weight_variation/approve/' . $labref . '/' . $r, array('id' => 'Ide')); ?>
<center>
    <div class="uniformity">
        <p><center><legend><h3>&#8801; NQCL WEIGHT VARIATION RESULTS</h3></legend></center></p>
        <?php if ($r > 1) {
            $repeat = $r - 1
            ?>
            <p><center><legend><h2>Sample Results &#187 <?php echo $labref; ?>&nbsp; &#187 &nbsp; <?php echo 'Repeat ' . $repeat; ?> &nbsp;|&nbsp;Posted &#187 <?php echo $uoc[0]->date_time; ?>  </h2></legend></center></p>
        <?php } else { ?>
            <p><center><legend><h2>Sample Results &#187 <?php echo $labref; ?>&nbsp; &#187 &nbsp; Posted &#187 <?php echo $uoc[0]->date_time; ?>  </h2></legend></center></p>
<?php } ?>
        </p>

        <hr>
        <div style="float:left"><input type="submit" value="Approve" style="background-color: #33ff33;color: #ffffff;" class="Inline"/>&nbsp;&nbsp;<a href="#rejectSample" id="Inline" style="background-color: #F00; color: #ffffff;">Reject</a></div>
        ...
        <center><div>
                ...
                <h3>Value</h3>
                <hr>
                <input type="text" value="<?php echo $uoc[0]->u_o_c ?>" name="uoc"/>
            ...
            <div id="comments_area">
                <textarea id="comments" cols="100" rows="5" name="comments" readonly class="phd"><?php echo $uoc[0]->remarks; ?></textarea>
            </div>
        </center>
        </form>
