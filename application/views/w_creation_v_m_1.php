...
<div id="cont" style=" display:none;">
    <div id="inst">
        ...
        <ol>
            <li>Design a worksheet template in Ms. Word (*.doc / *.docx).</li>  
            <li>Using Ms. Word, save the worksheet as a .pdf file/document</li>  
            <li>On the upload Give the worksheet a title.</li>            
            <li>Browse and find the worksheet to be uploaded e.g. assay.pdf.</li>
    ...
    <div id="uploader">
        ...
        <div id="up_form">
            <?php echo form_open_multipart('/custom_sheets/do_upload/'); ?>
            <br>
...
<div id="uploader_edit" style="display: none; width: 200; height: 200px;"> 
        <div id="up_form_edit">
            <?php echo form_open_multipart('/custom_sheets/do_upload_edit/'); ?>
            <br>
    ...
    <form>
        <table id = "sheets_table">
            ...
            <tr>          
                ...
                <td><a href="<?php echo base_url().'samplepdfs/'.$sheet->alias.'.pdf'; ?>" class="worksheet-Download" id="">Download</a></td>   
                <td><a href="#edit-custom-worksheet" class="edit-worksheet" id="<?php echo $sheet->id; ?>">Edit</a></td>   
                <td><a href="<?php echo base_url().'custom_sheets/delete_m/'.$sheet->id;?>" class="worksheet-Download" id="<?php echo ucfirst($sheet->alias); ?>">Delete</a></td>   
            </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
