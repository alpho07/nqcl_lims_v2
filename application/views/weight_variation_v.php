...
<form name="" action="" method="post" id="pHform">
    <center>
        <div class="uniformity">
            ...
            <legend><h4>&#8801; NQCL &#187; WEIGHT VARIATION DATA FORM &#187; SAMPLE : <?php echo $labref; ?> </h4></legend>
                   <hr>
                   <center><h3>Determination of Weight Variations</h3></center>
               <hr>
                    <div id="massses">
                <table>
                    <tr>
            ...
            <p><input type="button" value="Save Weight Variation Data" id="Save"/></p>
    ...
    $(document).ready(function() {
        ...
        $('#Save').click(function() {
            ...
            if (bad > 0) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url(); ?>weight_variation/save/<?php echo $labref.'/'.$test_id; ?>",
                                        data: dataString2,
                                        success: function() {
                                            $('#Save').prop('value', 'Save Weight Variation Data');
