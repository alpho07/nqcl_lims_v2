...
<legend><a href="<?php echo base_url(); ?>" >Home</a> | <a href="<?php echo base_url(); ?>supervisors" >My Home</a>  </legend>
<hr />
<div class="upload">

<div class="error" ><?php echo $error;?></div>

<?php echo form_open_multipart('supervisor_upload/do_upload/'.$labref);?>
