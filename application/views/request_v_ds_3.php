...
<legend>
    ...
    || <a href="<?php echo base_url(); ?>request_management/Analyst_report" >Analyst Report</a> 
</legend>            <div class="success">Success: Worksheet was successfully assigned for review</div>
            <div class="error">Error: Worksheet could not be assigned for review now, Please try again later!</div>
            <div class="content4" style="position: relative; height:400px !important;">
                ...
                <div id="filter3">
                                <form id="printing_form" method="post">
                                    ...
                                    <table>
                                        <tr><td colspan="2"><strong>My Review Report</strong></td></tr>
                                        ...
                                        <tr><td>         <tr>
                                            <td>
                                                <input name="reveiwer_data" id="reveiwer_data" readonly value="<?php echo $this->session->userdata('user_id');?>"/>
