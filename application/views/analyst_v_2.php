...
<legend>
    ...
    || <a href="<?php echo base_url(); ?>analyst_controller/" >Pending Samples</a> 
    || <a href="<?php echo base_url(); ?>analyst_controller/index_completed" >Completed Samples</a> 
    || <a href="<?php echo base_url() . 'analyst_controller/check_workbook/'; ?>" title="Uniformity of weight not Indicating 'DONE' even after saving?"> Check Workbook Status </a><div style="float: right;">
        ...
        <?php foreach ($tests_assigned as $test) { ?>
            ...
            if ($status != 3) {
                ...
                <tr class="sample_issue">
                    ...
                    <td class="common_data" ><input type="checkbox" name="set_done[]" value="<?php echo $test->Lab_ref_no ?>" class="my_checkboxes"/><span class="green_bold" id="labref" ><?php echo $test->Lab_ref_no ?>  &#187 Product Name: <?php echo $product_name ?>  &#187 Quantity Issued: <?php echo $test->Samples_no ?> &#187 Date & Time Issued: <?php echo $test->created_at ?></span> &#187
                        <?php if ($priority === '1') { ?>
                        ...
                        <?php } if($download_status >= 0 && $equip_status >= 0){ ?> &#187 <a href="#doenloadfullworksheets" id="<?php echo $test->Lab_ref_no; ?>" class="blink_me get_worksheets"><strong>GET WORKSHEETS</strong></a> || &#187 <a href="#removeCompleted" id="<?php echo $test->Lab_ref_no; ?>" class="blink_me get_completed_worksheets"><strong>GENERATE FINAL WORKSHEET</strong></a>
