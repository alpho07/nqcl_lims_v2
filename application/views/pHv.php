...
<form name="" action="" method="post" id="pHform">
    <center>
        <div class="uniformity">
            ...
            <legend><h4>&#8801; NQCL &#187; pH MEASUREMENT &#187; SAMPLE : <?php echo $labref; ?> </h4></legend>
            <hr>
            <p></p>
...
<!--                <tr class="">
            ...
            <p><input type="button" value="Save pH Data" id="Save"/></p>
       ...
       $data = "<?php echo Sample_issuance::getCompendiaStatus($labref, $test_id);?>";
        ...
        $('#Save').click(function() {
            ...
            if (bad > 0) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url(); ?>pH/save/<?php echo $labref.'/'.$test_id; ?>",
                                        data: dataString2,
                                        success: function() {
											window.location.href="<?php echo base_url();?>analyst_controller/"
                                            $('#Save').prop('value', 'Save pH Data');
