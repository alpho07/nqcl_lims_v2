    ...
    <div class="box round first grid">
        ...
        <div class="block">
            <legend><a href="<?php echo base_url(); ?>" >Home</a><div class="coding"> Key: 
                     <span id="documentation" style="width: 4px;height: 4px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>Sample Recieving&nbsp;&nbsp;&nbsp;&nbsp;
       ...
       <?php foreach ($location as $gps): ?>
                <tr>
                    ...
                    <?php } else if ($gps->stage === '2') { ?>
                        <td style=" width:50x; padding: 0px;"><div id="sec" >9%..</div></td>                   
        <!--                <td style="background: orange; text-align: center; color: black; font-weight: bolder;">9.09% Complete</td>-->
                    <?php } else if ($gps->stage === '3') { ?>
                        <td style=" width:50x; padding: 0px;"><div id="an-sup" >18%..</div></td>
                    <?php } else if ($gps->stage === '4') { ?>
                        <td style=" width:50x; padding: 0px;"><div id="sup" >28%..</div></td>                   
                    <?php } else if ($gps->stage === '5') { ?>
                        <td style=" width:50x; padding: 0px;"><div id="an-doc" >37%..</div></td>
        <!--                        <td><span style="background: yellow; text-align: center; color: black; font-weight: bolder; width: auto" >36.36% Complete</span> || <span style="background: blue; text-align: center; color: white; font-weight: bolder;">36.36% Complete</span></td>-->
                    <?php } else if ($gps->stage === '6') { ?>
                        <td style=" width:50x; padding: 0px;"><div id="doc" >45%..</div></td>
                    <?php } else if ($gps->stage === '7') { ?>
                        <td style=" width:50x; padding: 0px;"><div id="rev" >55%..</div></td>
                    <?php } else if ($gps->stage === '8') { ?>
                        <td style=" width:50x; padding: 0px;"><div id="doc2" >63%..</div></td>
                    <?php } else if ($gps->stage === '9') { ?>
                        <td style=" width:50x; padding: 0px;"><div id="ddir" >72%..</div></td>
                    <?php } else if ($gps->stage === '10') { ?>
                        <td style=" width:50x; padding: 0px;"><div id="sddir" >82%..</div></td>
                    <?php } else if ($gps->stage === '11') { ?>
                        <td style=" width:50x; padding: 0px;"><div id="doc3" >99% Completed!</div></td>
                    <?php }else{ ?>
                   <td style=" width:50x; padding: 0px;"><div id="doc31" >100% Completed!</div></td>
                    <?php } ?>
