...
$('#sendit').click(function() {
    ...
    $.ajax({
        type: 'post',
        url: '<?php echo base_url() . 'assay_injection/postRepeatReason/' . $labref; ?>',
        data: data,
      ...
      postData = $('#assayFormMultiple').serialize();
        ...
        $.ajax({
            ...
            url: "<?php echo base_url(); ?>assay_injection/save_assay_multiple/<?php echo $labref . '/' . $test_id; ?>",
                            data: postData,
                            success: function() {
...
$('#closeit').click(function(){
 ...
 $('#dialog').trigger('close');
       ...
       $.ajax({
           type:"GET",
           url:"<?php echo base_url(); ?>assay_injection/refsubs/" + substance,
           dataType:"json",
           success:function(data){
               $('#code').empty();
               $('#aqty').val('');                                                               
...
function loadComponents() {
    ...
    $.ajax({
        type: "GET",
        url: "<?php echo base_url(); ?>assay_injection/loadComponents/<?php echo $labref; ?>",
                        dataType: "json",
                        success: function(data) {
                            if (data == "5") {
...
$.ajax({
    type: "GET",
    url: "<?php echo base_url(); ?>assay_injection/loadRepeatComponents/<?php echo $labref; ?>",
                    dataType: "json",
                    success: function(data) {
    ...
    $.ajax({
        ...
        url: "<?php echo base_url(); ?>assay_injection/save_assay_multiple/<?php echo $labref.'/'.$test_id; ?>",
                ...
                function repeat() {
                    ...
                    $.ajax({
                        type: "GET",
                        url: "<?php echo base_url(); ?>assay_injection/loadComponents_lc/<?php echo $labref; ?>/" + select,
                        dataType: "json",
                        success: function(data) {
...
$(document).ready(function(){
    $('#smgml').keyup(function(){
     ...
     $('#workingmgml').keyup(function(){
      ...
      window.location.href="<?php echo base_url().'assay_injection/worksheet_c/'.$labref.'/'.$test_id.'/';?>";
...
<!--                            <td class="mgml"><input type="text" name="labelclaim" placeholder="0.04mg/ml" id ="labelclaim" value="" required  /></td>-->
                        ...
                        <tr>
                            <td colspan="9" class="weight" ><span style="margin-left: 40px;"><strong>Volume taken </strong></span></td>
                        <tr>
                            <td class="weight" ><strong> A &rarr;</strong></td>
...
<!--                        &nbsp;&nbsp;&nbsp;&nbsp;<input type="button" id="Export_r" value="Save & Repeat" class=""/><br />-->
            ...
            <script type="text/javascript" src="<?php echo base_url(); ?>javascripts/assay.min_injection_1.js"></script>
