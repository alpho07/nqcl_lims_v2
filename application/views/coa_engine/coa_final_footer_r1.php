...
//odfcanvas.load("<?php echo base_url(); ?>MANAGEMENT_FUNCTION.odt");
        ...
        function loadSignatories(labref) {
            ...
            $.getJSON(base_url + 'coa/getSignatoriesAJAX/' + labref, function (resp) {
                ...
                $.each(resp, function (i, data) {
                    //  console.log(data)
                    $row = ' <div class="form-group" > <div class="col-sm-2"> <input type="text" style="border :none;" name="designation[]" class="designator form-control" value=' + data.designation + ' style="text-align:left;"/></div> <div class="col-sm-3"> <input type="text" style="border :none; text-transform: uppercase;" name="designator[]" class="designator designator_name form-control" value="' + data.signature_name + '" style="text-align:left !important;"/></div>  <div class="col-sm-3"> <input type="text" style="border :none;" name="signature[]" class="signature form-control" value="________________________________________" readonly/> </div> <div class="col-sm-3"> <input type="text" style="border :none;" name="date[]" class="date datepick form-control" value=' + data.date_signed + ' placeholder="Enter Date"/></div><a  href="#remove-signatory"> <span class="fa fa-remove" data-sid=' + data.id + ' id="removeSignature"></span></a> </div>';
        ...
        setInterval(function () {
            ...
            $.ajax({
                ...
                success: function () {
                    ...
                    generate('success', "COA Successfully Autosaved");
