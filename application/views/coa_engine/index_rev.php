<?php $this->load->view('coa_engine/coa_final_head_rev'); ?>
<div class="widget-body " >
    <section id='printable_area'>
        ...
        <form class="form-horizontal" id="COAF">
            ...
            <div class="row col-md-6 col-md-offset-3 not_pintable" style="display:none;" >
                <dl>
                    <dd>
...
<!-- end widget content -->
<?php $this->load->view('coa_engine/coa_final_footer_rev'); ?>
