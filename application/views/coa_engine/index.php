...
<div class="widget-body " >
    ...
    <div class="row col-md-10 col-md-offset-2" id="heading"><strong><h3>NQCL DRAFT CERTIFICATE OF ANALYSIS >> Documentation Copy</h3> </strong></div>
    <form class="form-horizontal" id="COAF">
        ...
        <div class="row col-md-7 col-md-offset-2 not_pintable" style="margin-top:10px" >
            <dl>
                <dd>
                    ...
                    <button type="button"  class="btn btn-success" id="genCOAWordDATA"><span class="fa fa-briefcase"> Save & Assign Draft</span></button>
...
<!-- end widget content -->
<?php $this->load->view('coa_engine/coa_footer');?>
