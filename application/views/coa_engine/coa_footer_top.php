...
<div class="panel panel-success col-md-4 col-md-offset-4" style=" display: none; height:300px; margin-top: 100px;" id="data">
    <div class="panel panel-heading">
        <p><span class="fa fa-edit"> Assign Sample for Review</span></p>
    </div>
    <div class="panel panel-body">
        <form id="popup" class="form-horizontal" >
            ...
            <select name="director" required id="reviewer" class=" form-control select select2" style="width:300px;">
                                <option value="" selected="selected" >--Select Sample Reviewer--</option>
    ...
    <div class="panel panel-footer ">
        <input type="button" class="btn btn-primary btn-lg " id="assign_button1" value="Assign Sample for Review"/>
    </div>
</div>
...
<script>
    $(document).ready(function () {
		...
		four="<?php echo $this->uri->segment(4);?>";
		five="<?php echo $this->uri->segment(5);?>";
		six="<?php echo $this->uri->segment(6);?>";
        loadTopInfo(labref);
        loadTests(labref);
       //loadTestsRe(labref);
...
// This way you can also reduce the code within the caller.
        ...
        function saveCOA() {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url(); ?>coa/saveCOATOP/" + labref,
                data: postData,
                success: function () {

                    loadTopInfo(labref);
                    loadSampleTests(labref);
                    generate('success', 'Sample Information Successfully Saved');
 ...
 $('#coa_top_table').css('border','1px black solid');
   ...
   $('.tests_table,#addTest,.not_pintable').show();
        ...
        function load_reviewers(){
               ...
               $.ajax({
                    type: "POST",
                    url: "<?php echo base_url(); ?>assign/getReviewersArray_JSON/",
                    dataType: "JSON",
                ...
                $('#assign_button1').click(function() {
                    ...
                    if (rev == '') {
                      generate('error',"Assign Error: No Reviewer Selected!");
                        ...
                        $.ajax({
                            type: "POST",
                            url: "<?php echo base_url(); ?>assign/sendSamplesFolder/" + labref+"/"+four+"/"+five+"/"+six,
                            data: data1,
                            success: function(data)
                            {

                                generate('success',"Sample Successfully Assigned, Redirecting....");
                ...
                $.ajax({
                    ...
                    url: "<?php echo base_url(); ?>coa/saveCOATOP/"+labref,
                                    ...
                                    success: function() {
                                        ...
                                        generate('success',"Sample Information Successfully Autosaved");
