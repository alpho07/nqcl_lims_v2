<?php $this->load->view('coa_engine/coa_reviewer_head');?>
<div class="widget-body " >
    <input type="hidden" id="labref_coa"/>
        <div class="row col-md-12" id="heading"><strong><h3>DRAFT CERTIFICATE OF ANALYSIS >> COA Reviewers Copy</h3></strong></div>
    ...
    <form class="form-horizontal" id="COAF">
        <div class="row col-lg-12">
            <fieldset>
                ...
                <table id="coa_top_table" class="table-condensed">
                    ...
                    <tr>
                        <td align="center" valign="middle" id="side"> <span>MFG. DATE</span></td>
                    ...
                    <tr>
                        ...
                        <td align="left" valign="bottom" id="wording" style="font-size: 13px;"><textarea disabled="disabled" id="requested_tests" class="form-control"></textarea></td>
                    </tr>
                </table>
            </fieldset>
        </div>
        ...
        <div class="form-group">
            <table>
                ...
                <td>
                    <div class="col-md-10">
                        <textarea style="border :none; width: 728px;" class="form-control" placeholder="Conclusion" id="Conclusion" name="conclusion" rows="1">The product complies with the specifications for the tests performed.</textarea>
                    </div>
                </td>
            </table>
        </div>

        <div row class="col-md-10 col-md-offset-0" style="margin:0px; padding:0px;" id="signatoriesData">
        </div>

        <div class="row col-md-10 col-md-offset-2 not_pintable" >
            <dl>
                <dd>

                    <button type="button" class="btn  btn-info" id="BackButton"><span class="fa fa-backward"> Back</span></button>
                    <button type="button" class="btn btn-primary" id="genCOAWordDATA"><span class="fa fa-save"> Save Changes</span></button>
                    <button type="button" class="btn btn-warning" id="sendToDocumentation"><span class="fa fa-send-o"> Send To Documentation</span></button>
                    <button type="button" class="btn btn-success" id="sendDirect"><span class="fa fa-check-square-o"> Assign Draft to Reviewer</span></button>
                    <button type="button"  class="btn btn-success" id="genCOAp"><span class="fa fa-check-circle"> Approve</span></button>
                    <button type="button" class="btn btn-info" id="genCOAS"><span class="fa fa-print"> Print</span></button>
					                    <button type="button"  class="btn btn-default" id="invoice"><span class="fa fa-money"> Invoice</span></button>

                    <button type="button"  class="btn btn-warning" id="reCOA"><span class="fa fa-send-o"> Return for Correction</span></button>
                    <button type="button"  class="btn btn-danger" id="mOOS"><span class="fa fa-flag-o"> Mark As OOS</span></button>
					                        <button type="button"  class="btn btn-success" id="MSWORD"><span class="fa fa-download"> Save & Export - Ms.Word</span></button>
...
<!-- end widget content -->
<?php $this->load->view('coa_engine/reviewer_footer');?>
