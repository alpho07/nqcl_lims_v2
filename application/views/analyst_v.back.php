...
<legend><a href="<?php echo base_url(); ?>" ></a>  <a href="<?php echo base_url(); ?>analyst_labreference" ><span class="blink_me" style="color:greenyellow; background: black;">Upload / Download Excel</span></a> || <a href="<?php echo base_url(); ?>analyst_controller/loadfinal/" >Completed Test</a> || <a href="<?php echo base_url() . 'final_certificate/'; ?>"> View COA</a><div style="float: right;"><a href="#labrefs" id="sheets">Download Custom Worksheet</a></div></legend>
            ...
            if ($status != 3) {
                ...
                <tr class="sample_issue">
                    ...
                    <td class="common_data" ><span class="green_bold" id="labref" ><?php echo $test->Lab_ref_no ?>  &#187 Product Name: <?php echo $product_name ?>  &#187 Quantity Issued: <?php echo $test->Samples_no ?> &#187 Date & Time Issued: <?php echo $test->created_at ?></span> &#187
                        ...
                        <?php } if($download_status <= 0 && $equip_status >= 0){ ?> &#187 <a href="#doenloadfullworksheets" id="<?php echo $test->Lab_ref_no; ?>" class="blink_me get_worksheets"><strong>GET WORKSHEETS</strong></a> || &#187 <a href="#removeCompleted" id="<?php echo $test->Lab_ref_no; ?>" class="blink_me get_completed_worksheets"><strong>GENERATE FINAL WORKSHEET</strong></a> || &#187 <a style="color:red;"href="#removesample" id="removesample" data-labref="<?php echo $test->Lab_ref_no; ?>" class="remove_onesheet"><strong>Remove</strong></a> 
                    ...
                    <td><a href='<?php echo site_url() . $worksheet_name . "/worksheet/" . $lab_ref_no . "/" . $test_id ?>' class = '<?php
                        if ($test->desc_status == '0') {
                            ...
                            if ($test_id == '2' || $test_id == '5' || $test_id == "26" || $test_id == "49" || $test_id == "50" || $test_id == "9" || $test_id == "14") {
