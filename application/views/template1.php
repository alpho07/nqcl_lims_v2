...
<head>
		...
		<script src="<?php echo base_url() . 'javascripts/DataTables-1.9.3/extrasNew/dataTables.select.min.js' ?>" type="text/javascript"></script> 
		<link href="<?php echo base_url() . 'javascripts/DataTables-1.9.3/extrasNew/select.dataTables.min.css' ?>" type="text/css" rel="stylesheet"/> 
        <script src="<?php echo base_url() . 'javascripts/DataTables-1.9.3/extrasNew/dataTables.buttons.min.js' ?>" type="text/javascript"></script> 
		<link href="<?php echo base_url() . 'javascripts/DataTables-1.9.3/extrasNew/buttons.dataTables.min.css' ?>" type="text/css" rel="stylesheet"/> 
