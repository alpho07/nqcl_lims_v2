...
<form name="" action="" method="post" id="pHform">
    <center>
        <div class="uniformity">
            ...
            <legend><h4>&#8801; NQCL &#187; Loss on Drying &#187; SAMPLE : <?php echo $labref; ?> </h4></legend>
            <hr>
            <p></p>
            <h3>NB: If you have done LOD click the button bellow and if not, do LOD and come back and complete it here</h3>
            <hr>


     
            <p><input type="button" value="Already Saved on Excel - Update test Status" id="Save"/></p>
...
<script>
    $(document).ready(function() {
        ...
        $('#Save').click(function() {
                ...
                $('#Save').prop('value', 'Updating, Please Wait....');
                $('#Save').prop('disabled', 'disabled');
                dataString2 = $('#pHform').serialize();

                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url(); ?>Loss_on_drying/save/<?php echo $labref.'/'.$test_id; ?>",
                                        data: dataString2,
                                        success: function() {
