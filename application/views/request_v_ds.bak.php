        ...
        <div class="content4">
          ...
          <tr><td><label>End Date:</label> <input type="text" id="end" name="end"/></td></tr>
                    ...
                    <tr><td><input type="button"  value="Print Analyst Report" id="printer"/>
                        <input type="button"  value="Documentation Report" id="printerD"/></td></tr>
          ...
          <tr><td><label>End Date:</label> <input type="text" id="end_net" name="end"/></td></tr>
                ...
                <table>
                  <tr><td colspan="2"><strong>Supervisor Report</strong></td></tr>
                    <tr><td><label>Start Date:</label><input type="text" id="start2" name="start12"/></td></tr>
                    <tr><td><label>End Date:</label><input type="text" id="end2" name="end12"/></td></tr>
<!--					<tr><td>         <tr>
                                            <td>
                                                <label>Reviewer</label>
                                                <select name="reveiwer_data" id="reveiwer_data">
                    ...
                    <tr><td><input type="button"  value="Print Supervisor Report" id="printer2"/></td></tr>
                  ...
                  <table>
          <tr><td colspan="2"><strong>Client Sample Report</strong></td></tr>
          <tr><td><label>Start Date:</label><input type="text" id="start_cli" name="start"/></td></tr>
          <tr><td><label>End Date:</label> <input type="text" id="end_cli" name="end"/></td></tr>
          <tr><td><label>Departament: </label><select name="dept_cli" id="dept_cli">
                    <option value=""></option>
                    <option value="1">Wet Chemistry</option>
                    <option value="2">Microbiology</option>
                                                </select></td></tr>
					<tr><td><label>Client: </label><select name="client" id="client" style="width:450px;" class="select2">
					<option value=""></option>
                    ...
                    <tr><td><input type="button"  value="Print Report" id="printer_cli_1"/></td></tr>
	...
	$('.select2').select2();
            ...
            var $lmtable = $('#refsubs').dataTable({
				...
				"stateSave":true
                             ...
                             $(function() {
$( "#start,#end,#start1,#end1,#start11,#end11,#start2,#end2,#start_cli,#end_cli" ).datepicker({
     changeMonth: true,
changeYear: true,
dateFormat: 'yy-mm-dd'
});
