...
<form name="" action="" method="post" id="pHform">
    <center>
        <div class="uniformity">
            ...
            <legend><h4>&#8801; NQCL &#187; RELATED SUBSTANCES DATA FORM &#187; SAMPLE : <?php echo $labref; ?> </h4></legend>
                   <hr>
                   <center><h3>Determination value</h3></center>
               <hr>
                    <div id="massses">
                <table>
                    <tr>
                        <td>
                            <label>Determined Sample RS Value:  </label></td>
            ...
            <p><input type="button" value="Save Related Substances Data" id="Save"/></p>
    ...
    $(document).ready(function() {
        ...
        $('#Save').click(function() {
            ...
            if (bad > 0) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url(); ?>related_substances/save/<?php echo $labref; ?>",
                                        data: dataString2,
                                        success: function() {
                                            $('#Save').prop('value', 'Save Related Substances Data');
