...
<input name="fName" value= "<? echo set_value('fName');?>" type="text" />
</td></tr>

<tr><td>Last Name:</td><td>
<?php echo form_error('lName'); ?>
<input name="lName" value= "<? echo set_value('lName');?>" type="text" />
</td></tr>

<tr><td>Telephone:</td><td>
<?php echo form_error('tPhone'); ?>
<input name="tPhone" value= "<? echo set_value('tPhone');?>" type="text" maxlength=""/>
</td></tr>

<tr><td>Email Address:</td><td>
<?php echo form_error('email'); ?>
<input name="email" value= "<? echo set_value('email');?>" type="text" />
</td></tr>
...
<tr><td>Account Status</td><td><input type="radio" name="status" value="1" label="Activate"/>Activate</td>
<tr><td></td><td><input type="radio" name="status" value="0"/>Deactivate</td>

<tr><td><input type = "hidden" name = "dbid" value ="<?php echo set_value('dbid',$_POST['dbid']); ?>" /></td></tr>

<tr><td colspan="2"><hr></td><tr>

<tr><td align="center" colspan="2"><input onclick="formClose()" type="submit" value="Update"/></td></tr>
</table>
</form>
</body>
</html>
