...
<p>
<p><strong><center>ANALYST SINGLE SHEET REDOWNLOAD CENTER</center></strong></p><hr>
<legend><a href="#">Repository</a></legend></p>
<hr>
    ...
    <form>
        <table id = "sheets_table">
            ...
            <tr>          
                ...
                <td><a  href="<?php echo base_url().'analyst_controller/generateSingle/'.$sheet->id.'/'.$sheet->alias.'/'.$sheet->name; ?>"  id="REQUEST">Next</a></td>   
