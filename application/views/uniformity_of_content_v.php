...
<form name="" action="" method="post" id="pHform">
    <center>
        <div class="uniformity">
            ...
            <legend><h4>&#8801; NQCL &#187; UNIFORMITY OF CONTENTS DATA FORM &#187; SAMPLE : <?php echo $labref; ?> </h4></legend>
                   <hr>
                   <center><h3>Determination of Uniformity of Contents</h3></center>
               <hr>
                    <div id="massses">
                <table>
                    <tr>
                        <td>
                            <label>Determined :  </label></td>
                        <td><input type="text" id="phmeanc" name="sampleph" class="phmean"  required value=""/>
                        </td>
                    </tr>
            ...
            <p><input type="button" value="Save Uniformity of Contents Data" id="Save"/></p>
    ...
    $(document).ready(function() {
        ...
        $('#Save').click(function() {
            ...
            if (bad > 0) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url(); ?>uniformity_of_content/save/<?php echo $labref; ?>",
                                        data: dataString2,
                                        success: function() {
                                            $('#Save').prop('value', 'Save Uniformity of Contents Data');
