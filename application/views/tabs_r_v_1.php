...
<div id="main_wrapper"> 
    ...
    <h1><center><legend><h2>NQCL Uniformity of Weight Result</h2></legend></center></h1>
    <p>
    <p>
    <center><legend><h2>Sample: <?php echo $labref; ?> &nbsp;|| &nbsp; Posted on: <?php echo $date[0]->date_time;?></h2></legend></center>
</p>
</p>

<div id="Individual_box">

    <?php echo form_open('tabs/approve/'.$labref.'/'.$r,array('id'=>'tabsE')); ?> 
    <table id="TabsTabeUniformity" width="230" border="0" align="center" cellpadding="0" cellspacing="0" value="" class="dave-table">

      <input type="hidden" value="uniformity" name="heading"/>  
        ...
        <td colspan="5"> <strong><?php echo "";?></strong></td>
    </table>
