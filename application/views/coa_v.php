				...
				$.ajax({
					...
					url: "<?php echo base_url(); ?>coa/saveCOA/<?php echo $labref; ?>",
									...
									success: function() {
									  ...
									  window.location.href="<?php echo base_url(); ?>COA/<?php echo $labref; ?>_COA.xlsx";
									  return true;
									},
									error: function() {
										showNotification({
...
<div id="COA_AREA">
	<form action="" id="COAF" method="post">   
				...
				<div id="coa_top">
					...
					<table id="coa_top_table">
						<tr id="top_row">
							...
							<td id="middle_head" align="left"><?php echo $information[0]->product_name; ?></td>
							<td id="last_head" align="left" valign="middle"><span>REF. NO:</span>&nbsp;<?php echo $information[0]->request_id; ?></td>
						</tr>
						<tr>
		...
		<input type="button" value="Generate COA" id="genCOA" name="genCOA"/>
		</center>        
	</form>
	<br>
