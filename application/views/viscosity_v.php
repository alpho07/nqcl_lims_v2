...
<form name="" action="" method="post" id="pHform">
    <center>
        <div class="uniformity">
            ...
            <legend><h4>&#8801; NQCL &#187; VISCOSITY DATA FORM &#187; SAMPLE : <?php echo $labref; ?> </h4></legend>
                   <hr>
               ...
               <hr>
                ...
                <table>
                    <tr>
                        <td>
                            <label>Determined Sample Viscosity:  </label></td>
            ...
            <p><input type="button" value="Save Viscosity Data" id="Save"/></p>
    ...
    $(document).ready(function() {
        ...
        $('#Save').click(function() {
            ...
            if (bad > 0) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url(); ?>viscosity/save/<?php echo $labref.'/'.$test_id; ?>",
                                        data: dataString2,
                                        success: function() {
