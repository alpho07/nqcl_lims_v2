...
<?php echo form_open('dissolution/save_dissolution_data/' . $labref, $attributes); ?>       
        ...
        <div id="diss-top"> 
            <table width="553" class="toptable" >
                ...
                <tr>
                    <td>1</td>
                    <td><input type="text" name="tc1" id="tc1" class="dissolution-class  dissdata dissclear"  tabindex="1"/></td>
                ...
                <tr>
                    <td>2</td>
                    <td><input type="text" name="tc2" id="tc2" class="dissolution-class dissdata dissclear"  tabindex="2"/></td>
                ...
                <tr>
                    <td>3</td>
                    <td><input type="text" name="tc3" id="tc3" class="dissolution-class dissdata dissclear"  tabindex="3"/></td>
                    <td>Apparatus</td>
                    <td>
                ...
                <tr>
                    <td>4</td>
                    <td><input type="text" name="tc4" id="tc4" class="dissolution-class dissdata dissclear"  tabindex="4"/></td>
                    <td>RPM </td>
                    <td><input type="text" name="Rm" placeholder="" value="" id="Rm" required="required" class="dissclear"/>
                    </td>
                    <td><input type="text" name="Rm2" placeholder="" value="" id="Rm2" class="stage2 dissclear"  /></td>
                </tr>
                <tr>
                    <td>5</td>
                    <td><input type="text" name="tc5" id="tc5" class="dissolution-class dissdata dissclear"  tabindex="5"/></td>
                    <td>Time (mins)</td>
                    <td>
                ...
                <tr>
                    <td>6</td>
                    <td><input type="text" name="tc6" id="tc6" class="dissolution-class dissdata"  tabindex="6"/></td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                </tr>
            ...
            <div id="sample"> 
                ...
                <table id="assay">               
                    ...
                    <tr>
                        ...
                        <td class="mgml"><input type="text" name="dmgml" placeholder="e.g 0.04mg/ml" id ="dmgml" value="" required readonly class="dissclear"/></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="mgml1"><input type="text" name="dmgml1" placeholder="e.g 0.04mg/ml" value="" id="dmgml1" required readonly class="dissclear" /></td>
                    </tr>
