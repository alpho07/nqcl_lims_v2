...
<?php echo form_open('uniformity_of_content/approve/' . $labref . '/' . $r, array('id' => 'Ide')); ?>
    <center>
        <div class="uniformity">

            <p><center><legend><h3>&#8801; NQCL UNIFORMITY OF CONTENTS RESULTS</h3></legend></center></p>
            <?php if ($r > 1) {
                $repeat = $r - 1
                ?>
            ...
            <center><div>
                    ...
                    <h3>Determined</h3>
                    <hr>
                   Value : <input type="text" value="<?php echo $uoc[0]->u_o_c ?>" name="uoc"/>
