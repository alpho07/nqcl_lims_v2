...
<script type="text/javascript">
  ...
  $('#repeat_uniformity').change(function() {
       repeat_uniformity = $(this).val();
       
       window.location.href="<?php echo base_url().'uniformity/uniformity_r/'.$labref.'/'?>"+repeat_uniformity+"/0";

       });
        function loadRepeats() {
    var select = $('#repeat_uniformity').empty();
    $.ajax({
        type: "GET",
        url: "<?php echo base_url(); ?>uniformity/repeats/<?php echo $labref; ?>",
                    dataType: "json",
                    success: function(data) {
...
<p><center><legend><h2>Sample Results: <?php echo $labref;?>&nbsp;|&nbsp;Uniformity of Weight <?php echo $component_name[0]->component;?> &nbsp; <?php echo 'Repeat '. $repeat;?> &nbsp;|&nbsp;Posted: <?php echo $date_time[0]->date_time;?>  </h2></legend></center></p>
     <?php } else{ ?>
<p><center><legend><h2>Sample Results: <?php echo $labref;?>&nbsp;|&nbsp;Uniformity of Weight <?php echo $component_name[0]->component;?> &nbsp;|&nbsp;Posted: <?php echo $date_time[0]->date_time;?>  </h2></legend></center></p>
      <?php  } ?>
    ...
    <div id="Individual_box">
        <?php //echo $done;?>
        <p>Run No</p>
        <p><select id="repeat_uniformity"></select></p>
        ...
        <table width="600" border="0" align="center" cellpadding="0" cellspacing="0" class="dave-table">
            ...
            <tr>
                ...
                <td width="138" valign="middle"></label></td>
