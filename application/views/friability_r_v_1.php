...
<form name="" action="" method="post" id="friabilityForm">
    <center>
        <div class="uniformity">
            <legend><h4>&#8801; NQCL &#187; RESULTS FOR FRIABILITY TEST &#187; SAMPLE : <?php  echo $labref;   ?> </h4></legend>
            <hr>
            <table class="tg-table-light">
                ...
                <tr class="tg-even">
                    <td>Before Test (g)</td>
                    <td><input type="text" id="fbtest" name="fbtest"  class="fbtest" readonly value="<?php echo $friability_data[0]->tw_before_test;?>" tabindex="1"/></td>

                </tr>
                <tr>
                    <td>After Test (g)</td>

                    <td><input type="text" id="fbatest" name="fbatest" class="fbatest"  readonly value="<?php echo $friability_data[0]->tw_after_test;?>" tabindex="2"/>

                </tr>

                <tr class="tg-even">
                    <td>Loss (g)</td>                   
                    <td><input type="text" id="fbloss" name="fbloss"   class="fbtest" readonly="readonly" value="<?php echo $friability_data[0]->loss;?>"  /></td>                   
                </tr> 
            </table>
            ...
            <div id="massses">
                <table>
                    <tr>
                        <td>
                            <label>% Loss: </label></td>
                        <td><input type="text" id="fbploss" name="fbploss" class="fbtest"  readonly="readonly" value="<?php echo $friability_data[0]->	percentage_loss;?>"/>
                        </td>
                    </tr>
            ...
            <div id="comments_area">
                <textarea id="comments" cols="50" rows="5" name="comments" readonly ><?php echo $friability_data[0]->comments;?></textarea>
            </div>
...
<script>
        ...
        $(document).ready(function(){             
                ...
                $('#submit_result').click(function(){        
                    dataString2 = $('#friabilityForm').serialize();
                                $.ajax({
                                    type: "POST",
                                    url: "<?php echo base_url(); ?>wkstest_1/friability/<?php echo $labref; ?>",
                                    data: dataString2,
                                    success: function() {
