...
<center><div id="top">Upload Microbiology Excel Template Here</div></center>
<hr>
...
<div id="cont" style=" display:none;">
    <div id="inst">
        ...
        <ol>
            <li>Design a worksheet template in Excel (*.xlsx).</li>  
            <li>On the upload Give the worksheet a title.</li>            
            <li>Browse and find the worksheet to be uploaded e.g. Microbial Assay.xlsx.</li>
    ...
    <div id="uploader">
        ...
        <div id="up_form">
            <?php echo form_open_multipart('/microbiology_worksheets/do_upload/'); ?>
            <br>
...
<div id="uploader_edit" style="display: none; width: 200; height: 200px;"> 
        <div id="up_form_edit">
            <?php echo form_open_multipart('microbiology_worksheets/do_upload_edit/'); ?>
            <br>
    ...
    <form>
        <table id = "sheets_table">
            ...
            <tr>          
                ...
                <td><a href="<?php echo base_url().'microbiology_custom_worksheets/'.$sheet->alias.'.xlsx'; ?>" class="worksheet-Download" id="">Download</a></td>   
                <td><a href="#edit-custom-worksheet" class="edit-worksheet" id="<?php echo $sheet->id; ?>">Edit</a></td>   
                <td><a href="<?php echo base_url().'microbiology_worksheets/delete_m/'.$sheet->id;?>" class="worksheet-Download" id="<?php echo ucfirst($sheet->alias); ?>">Delete</a></td>   
            </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
