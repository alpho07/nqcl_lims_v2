...
<legend><a href="<?php echo base_url().'analyst_controller/worksheet_center';?>">Repository</a> &#187 <a href="<?php echo base_url().'analyst_controller/worksheet_uploads';?>">Upload sheets</a> &#187 <a href="<?php echo base_url().'analyst_controller/my_repo';?>">My Repository</a></legend></p>
<hr>
...
<div id="worksheet" style="  height: auto;">
    <form>
        <table id = "sheets_table">
            ...
            <tr>          
                <td><?php echo $sheet->request_id; ?></td>
                <td><?php echo $sheet->full_name; ?></td>
                <td><a href="<?php echo base_url().'samplepdfs/'.$sheet->full_name.'.pdf'; ?>" class="worksheet-Download" id="">Download</a></td>   
