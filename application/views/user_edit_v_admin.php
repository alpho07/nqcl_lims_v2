...
echo form_open('user_registration_admin/user_edit/', $attrib);
?>
<table id="table1">

<tr><td>Username</td><td>
<?php echo form_error('uName'); ?>
<input disabled="true" name="uName" value= "<?php echo $r[0]->username;?>" type="text" maxlength=""/>
</td></tr>
...
<input disabled = "true" name="email" value= "<?php echo $r[0]->email;?>" type="text" />
</td></tr>
...
<input type="checkbox" name="userType[]" value="1" class= "users2" <?php if($r[0]->user_type== 1 || $r[0]->user_type== 6){echo'checked="checked"';} ?>>Analyst</td></tr>        
<tr><td></td><td><input type="checkbox" name="userType[]" value="5" <?php if($r[0]->user_type== 2 || $r[0]->user_type== 6){echo'checked="checked"';} ?>>Supervisor<td></tr>
<tr><td></td><td><input type="checkbox" name="userType[]" value="3" class= "users1"<?php if($r[0]->user_type== 3 || $r[0]->user_type== 5){echo'checked="checked"';} ?>>Reviewer</td></tr>
<tr><td></td><td><input type="checkbox" name="userType[]" value="4" class= "users1" <?php if($r[0]->user_type== 4 || $r[0]->user_type== 5){echo'checked="checked"';} ?>>Administrator</td></tr>
<tr><td></td><td><input type="checkbox" name="userType[]" value="8" class= "users3" <?php if($r[0]->user_type== 7){echo'checked="checked"';} ?>>Documentation</td></tr>
