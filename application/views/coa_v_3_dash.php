        ...
        $(document).ready(function() {
            ...
            $('select.det').change( function() {
                ...
                if ($.inArray('DOES NOT COMPLY', data.replace(/,\s+/g, ',').split(',')) >= 0) {
                   $('#complies11').val('DOES NOT COMPLY');
                      }else{
                     $('#complies11').val('COMPLIES');  
                    }
           ...
           if(coa_status =='1'){
                ...
                $.ajax({
                    ...
                    url: "<?php echo base_url(); ?>coa/saveClient/<?php echo $information[0]->client_id ; ?>",
                                    ...
                                    $.fancybox.close();
                                      ...
                                      window.location.href = "<?php echo base_url() . 'coa/generateCoa_dash/'.$labref; ?>";
            ...
            $('#genCOA').click(function() {
               ...
               //$(this).prop('disabled', 'disabled');
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url(); ?>coa/saveCOA/<?php echo $labref; ?>/coa_director",
                                    data: postData,
                                    success: function() {
                                        ...
                                        $('#genCOA').prop('value', 'Save Changes');
							 ...
							 $('#genCOAA').click(function() {
								 
								 	var txt;		
    var r = confirm("ALERT: This Draft COA for sample <?php echo $labref;?> will be approved and forwarded to Documentation, Do you want to continue?");
    if (r === true) {
		   $(this).prop('value', 'Processing....');
		    postData = $('#COAF').serialize();
        	$.ajax({
					type:'post',
					url:"<?php echo base_url().'directors/approve_d/'.$labref;?>",
					data:postData,
					success:function(){
						  showNotification({
                                            message: "COA Successfully Forwarded to Documentation! ",
                                            type: "success",
                                            autoClose: true,
                                            duration: 5
                ...
                $.ajax({
                    ...
                    url: "<?php echo base_url(); ?>coa/saveCOA/<?php echo $labref; ?>",
                            ...
                            $('#Back').click(function() {
                             ...
                             $(document).on('click','#view_log_beta',function(){
                           window.location.href = "<?php echo base_url() . 'main_dashboard/generateReport/'; ?>"+$(this).attr('class');
...
<div id="LogInfo">
    <!--<button id="view_log" class="<?php echo $information[0]->request_id; ?>">View Sample Log</button> <br>-->
     <button id="view_log_beta" class="<?php echo $information[0]->request_id; ?>">View Sample Log Beta- version</button>
</div>
...
<div id="COA_AREA">
    <form action="" id="COAF" method="post">   
        <center><div id="content">
                ...
                <center><?php echo $fyear .'____'; ?></center>
                <p></p>
                <p>
                <div id="coa_top">
                     ...
                     <table id="coa_top_table">
                       ...
                       <tr align="center" valign="middle">
                        ...
                        <tr>
                            <td height="40" align="center" valign="middle" id="side"><textarea name="client_ref" rows='1' col="1"><?php echo $information[0]->clientsampleref; ?></textarea></td>
...
<?php }; ?>
                ...
                <p>
                    <input type='hidden' name='complies11' id='complies11'/>
...
<?php endforeach; ?>
                ...
                <input type="button" value="Approve" id="genCOAA" name="genCOAApproval"/>   				
