...
<?php echo form_open('viscosity/approve/'.$labref.'/'.$r.'/'.$c); ?>
    <center>
        <div class="uniformity">
              <p><center><legend><h3>&#8801; NQCL VISCOSITY RESULTS</h3></legend></center></p>
            <?php if ($r > 1) {
                $repeat = $r - 1 ?>
                <p><center><legend><h2>Sample Results &#187 <?php echo $labref; ?>&nbsp; &#187 &nbsp; <?php echo 'Repeat ' . $repeat; ?> &nbsp;|&nbsp;Posted &#187 <?php echo $viscosity_data[0]->date_time; ?>  </h2></legend></center></p>
            <?php } else { ?>
                <p><center><legend><h2>Sample Results &#187 <?php echo $labref; ?>&nbsp; &#187 &nbsp; Posted &#187 <?php echo $viscosity_data[0]->date_time; ?>  </h2></legend></center></p>
            <?php } ?>
            </p>
                <hr>

            <p></p>
                   <center><h3>Determination of Viscosity</h3></center>
               <hr>
                    <div id="massses">
                <table>
                    <tr>
                        <td>
                            <label>Determined value for Viscosity Test:  </label></td>
                        <td><input type="text" id="phmeanc" name="sampleph" class="phmean"  readonly value="<?php echo $viscosity_data[0]->run;?>"/>
                        </td>
                    </tr>
            ...
            <div id="comments_area">
                <textarea id="comments" cols="100" rows="5" name="comments" readonly class="phd"><?php echo $viscosity_data[0]->remarks;?></textarea>
            </div>
            <p>
