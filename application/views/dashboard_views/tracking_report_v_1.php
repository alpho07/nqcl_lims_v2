...
<style type="text/css">
.tg  {border-collapse:collapse;border-spacing:0;border-color:#bbb; width: 100%; margin:0 auto 0 auto;}
...
<table class="tg  table-hover table-condensed">
  <tr>
    <th class="tg-ufsm" colspan="5">TRACKING LOG &#187 <?php echo $labref;?> </th>
  </tr>
  <tr id="head">
...
<?php } else {?>
	<tr>
		<td colspan = "5">No Tracking Data Available.</td>
	</tr>
<?php }
?>
...
<table class="tg  table-hover table-condensed">
  <tr>
    <th class="tg-ufsm" colspan="4">TESTS REPORT &#187 <?php echo $labref;?> </th>
  </tr>
  <tr id="head">
    <td class="tg-031e">No.</td>
    <td class="tg-ugh9">ANALYST</td>
    <td class="tg-031e">TEST</td>
    <td class="tg-ugh9">STATUS</td>
  </tr>
  <?php  
  $i=1;
  
 
  foreach($tracking_two as $track_one1):?>
  <tr>
    <td class="tg-031e"><?php echo $i;?></td>
    <td class="tg-ugh9"><?php  echo $track_one1->name;?></td>
    <td class="tg-031e"><?php echo $track_one1->test;?></td>
    <td class="tg-ugh9"><?php 
	if($track_one1->done_status == 1)
		echo 'Complete';
	else
		echo 'Pending';
	?></td>
