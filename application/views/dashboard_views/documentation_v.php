...
<script language="JavaScript">
    function drawChart(chartSWF, strXML, chartdiv) {
        ...
        var chart = new FusionCharts(chartSWF, "chart1Id", "450", "350", "0", "0");
...
<div class="row-fluid">
    ...
    <div class="box blue span6 noMargin" ontablet="span12" ondesktop="span6">
        <div class="box-header">
            <h2>Samples per Month Per Client <?php echo date('Y'); ?></h2>
        </div>
        <div class="box-content">

            <div id="gen-chart-render" class = "samplesPerClientByMonth">
                <select name="changeDataClient" id="changeDataClient" title="Select Client" >
                <?php foreach ($clients as $client) { ?>
                    <option value="<?php echo $client->id; ?>" ><?php echo $client->Name; ?></option>
                <?php }?>    
            </select>
            <select name="changeData" id="changeYear1">
                <?php foreach ($years as $every_year): ?>
                    <option value="<?php echo $every_year; ?>" ><?php echo $every_year; ?></option>
                <?php endforeach; ?>    
            </select>
            <select name="changeChart" id="changeChart1">
                <option value="3d">3D Version</option>
                <option value="2d">2D Version</option>
            </select><br>
            <div id="chart1div1" align="left">Loading Data, Please Wait....</div>
...
<div class = "row-fluid">
    <div class="box blue span6 noMargin" ontablet="span12" ondesktop="span6">
        <div class="box-header">
            <h2>Active Ingredients Per Month</h2>
        </div>
        <div class ="box-content">
            <div class = "activeIngredientsPerMonth">

                <select name="changeData" id="changeYear2">
                    <?php foreach ($years as $every_year): ?>
                        <option value="<?php echo $every_year; ?>" ><?php echo $every_year; ?></option>
                    <?php endforeach; ?>    
                </select>
                <select name="changeChart2" id="changeChart2">
                    <option value="3d">3D Version</option>
                    <option value="2d">2D Version</option>
                </select><br>
                <div id="chart1div2" align="left">Loading Data, Please Wait....</div>
    ...
    <div class="box blue span6 noMargin" ontablet="span12" ondesktop="span6">
        <div class="box-header">
            <h2>Certificates Done Per Month</h2>
        </div>
        <div class ="box-content">
            <div class = "certsDonePerMonth">
                <select name="changeData" id="changeYear3">
                    <?php foreach ($years as $every_year): ?>
                        <option value="<?php echo $every_year; ?>" ><?php echo $every_year; ?></option>
                    <?php endforeach; ?>    
                </select>
                <select name="changeChart3" id="changeChart3">
                    <option value="3d">3D Version</option>
                    <option value="2d">2D Version</option>
                </select><br>
                <div id="chart1div3" align="left">Loading Data, Please Wait....</div>
...
<div class = "row-fluid">
    <div class="box blue span6 noMargin" ontablet="span12" ondesktop="span6">
        <div class="box-header">
            <h2>Certificates Collected Per Month</h2>
        </div>
        <div class ="box-content">
            <div class = "certsCollectedPerMonth">
                <select name="changeData" id="changeYear4">
                    <?php foreach ($years as $every_year): ?>
                        <option value="<?php echo $every_year; ?>" ><?php echo $every_year; ?></option>
                    <?php endforeach; ?>    
                </select>
                <select name="changeChart3" id="changeChart4">
                    <option value="3d">3D Version</option>
                    <option value="2d">2D Version</option>
                </select><br>
                <div id="chart1div4" align="left">Loading Data, Please Wait....</div>
     ...
     <div class="box blue span6 noMargin" ontablet="span12" ondesktop="span6">
        <div class="box-header">
            <h2>Samples Per Manufacturer</h2>
        </div>
        <div class ="box-content">
            <div class = "samplesPerManufacturer">
                <select name="changeData" id="changeYear5">
                    <?php foreach ($years as $every_year): ?>
                        <option value="<?php echo $every_year; ?>" ><?php echo $every_year; ?></option>
                    <?php endforeach; ?>    
                </select>
                <select name="changeChart3" id="changeChart5">
                    <option value="3d">3D Version</option>
                    <option value="2d">2D Version</option>
                </select><br>
                <div id="chart1div5" align="left">Loading Data, Please Wait....</div>
...
<div class = "row-fluid">
 <div class="box blue span6 noMargin" ontablet="span12" ondesktop="span6">
        <div class="box-header">
            <h2>Samples Per Country of Origin</h2>
        </div>
        <div class ="box-content">
            <div class = "samplesPerCountry">
                <select name="changeData" id="changeYear6">
                    <?php foreach ($years as $every_year): ?>
                        <option value="<?php echo $every_year; ?>" ><?php echo $every_year; ?></option>
                    <?php endforeach; ?>    
                </select>
                <select name="changeChart3" id="changeChart6">
                    <option value="3d">3D Version</option>
                    <option value="2d">2D Version</option>
                </select><br>
                <div id="chart1div6" align="left">Loading Data, Please Wait....</div>
     ...
     <div class="box blue span6 noMargin" ontablet="span12" ondesktop="span6">
        <div class="box-header">
            <h2>Samples Per Test</h2>
        </div>
        <div class ="box-content">
            <div class = "samplesPerTest">
                <select name="changeData" id="changeYear7">
                    <?php foreach ($years as $every_year): ?>
                        <option value="<?php echo $every_year; ?>" ><?php echo $every_year; ?></option>
                    <?php endforeach; ?>    
                </select>
                <select name="changeChart3" id="changeChart7">
                    <option value="3d">3D Version</option>
                    <option value="2d">2D Version</option>
                </select><br>
                <div id="chart1div7" align="left">Loading Data, Please Wait....</div>
...
<div class = "row-fluid">
 <div class="box blue span6 noMargin" ontablet="span12" ondesktop="span6">
        <div class="box-header">
            <h2>Samples Per Test Per Month</h2>
        </div>
        <div class ="box-content">
            <div class = "samplesPerTestPerMonth">
                <select name="changeData" id="changeYear8">
                    <?php foreach ($years as $every_year): ?>
                        <option value="<?php echo $every_year; ?>" ><?php echo $every_year; ?></option>
                    <?php endforeach; ?>    
                </select>
                <select name="changeData" id="changeMonth8">
                    <?php foreach ($m as $month): ?>
                        <option value="<?php echo $month; ?>" ><?php echo $month; ?></option>
                    <?php endforeach; ?>    
                </select>
                <select name="changeChart3" id="changeChart8">
                    <option value="3d">3D Version</option>
                    <option value="2d">2D Version</option>
                </select><br>
                <div id="chart1div8" align="left">Loading Data, Please Wait....</div>
     ...
     <div class="box blue span6 noMargin" ontablet="span12" ondesktop="span6">
        <div class="box-header">
            <h2>Samples Per Unit</h2>
        </div>
        <div class ="box-content">
            <div class = "samplesPerUnit">
                <select name="changeData" id="changeYear9">
                    <?php foreach ($years as $every_year): ?>
                        <option value="<?php echo $every_year; ?>" ><?php echo $every_year; ?></option>
                    <?php endforeach; ?>    
                </select>
                <select name="changeChart3" id="changeChart9">
                    <option value="3d">3D Version</option>
                    <option value="2d">2D Version</option>
                </select><br>
                <div id="chart1div9" align="left">Loading Data, Please Wait....</div>
...
<div class = "row-fluid">
         <div class="box blue span6 noMargin" ontablet="span12" ondesktop="span6">
        <div class="box-header">
            <h2>Samples Per Unit per Month</h2>
        </div>
        <div class ="box-content">
            <div class = "samplesPerUnitPerMonth">
                <select name="changeData" id="changeYear10">
                    <?php foreach ($years as $every_year): ?>
                        <option value="<?php echo $every_year; ?>" ><?php echo $every_year; ?></option>
                    <?php endforeach; ?>    
                </select>
                <select name="changeData" id="changeUnit10">
                    <?php foreach ($units as $u): ?>
                        <option value="<?php echo $u->id; ?>" ><?php echo $u->name; ?></option>
                    <?php endforeach; ?>    
                </select>
                <select name="changeChart3" id="changeChart10">
                    <option value="3d">3D Version</option>
                    <option value="2d">2D Version</option>
                </select><br>
                <div id="chart1div10" align="left">Loading Data, Please Wait....</div>
            </div>
        </div>
    </div>
</div>
...
<div class = "row-fluid hidden2" id = "details_table" >
        <div class ="box-content">
            <table id = "stable">
                <thead>
                    <tr></tr>
