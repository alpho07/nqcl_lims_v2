<head>
        <script src="<?php echo base_url() . 'bower_components/datatables/media/js/jquery.js' ?>" type="text/javascript"></script>
...
<a class="btn btn-large" href="<?php echo base_url();?>main_dashboard/samples"><< Back</a>