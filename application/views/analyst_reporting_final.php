...
<html>
    ...
    <body>
                        <a href="<?php echo base_url();?>report_engine/analyst_report_hod/12/2016">See Draft</a>
            ...
            <div class="content_area" >
                <center>
                    ...
                    <div class="content ">
                        ...
                        <p>Month: <select class="mn" name="month" id="MONTH" >
...
echo Date('F', strtotime($currentMonth . " last month")); ?></option>
                    ...
                    <div class="footer">
                        ...
                        <p class="btl">Total Number of Samples Received: <input type="text" class="input-lg mn" id="TotSamples" name="tns"/> </p>
                        ...
                        <table class="tg">
                            ...
                            <tr>
                                <td class="tg-yw4l"><span id="AnalystName"></span></td>
                                <td class="tg-yw4l"></td>
                                <td class="tg-yw4l"></td>
                            </tr>
                            <tr>
...
<script>
    $(document).ready(function () {
        ...
        function loadRS(m, y,a) {
            $.getJSON(base_url + 'serveLookupSu/' + m + '/' + y + '/' + a +'/RS', function (resp) {
                table = $('.RS > tbody');
                $('.RS tbody').empty();
                $.each(resp, function (i, d) {
        ...
        function loadOT(m, y,a) {
            $.getJSON(base_url + 'serveLookupSu/' + m + '/' + y + '/' + a +'/OT', function (resp) {
                table = $('.OT > tbody');
                $('.OT > tbody').empty();
                $.each(resp, function (i, d) {
        ...
        function loadPS(m, y,a) {
            $.getJSON(base_url + 'serveLookupSu/' + m + '/' + y + '/' + a +'/PS', function (resp) {
                table = $('.PS > tbody');
                $('.PS > tbody').empty();
                $.each(resp, function (i, d) {
        ...
        function loadOD(m, y,a) {
            $.getJSON(base_url + 'serveLookupSetailsSu/' + m + '/' + y+ '/' + a, function (resp) {
        ...
        $('#MONTH,#YEAR,#AID').change(function () {
            m = $('#MONTH').val();
            y = $('#YEAR').val();
            a = $('#AID').val();
            $('#AnalystName').text($('#AID option:selected').text());
            loadRS(m, y,a);
            loadOT(m, y,a);
            loadPS(m, y,a);
            loadOD(m, y,a);
