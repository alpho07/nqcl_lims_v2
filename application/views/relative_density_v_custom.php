    ...
    <center>
        <div class="uniformity">
            ...
            <table class="tg-table-light">
                ...
                <tr class="tg-even">
                    <td></td>
                    <td><input type="text" id="pykmass" name="pykmass"  class="pykmass rd" required value="" tabindex="1"/></td>
                    <td><input type="text" id="pykwater" name="pykwater"  class="pykwater rd" value="" required tabindex="2"/></td>
                    <td><input type="text" id="pyksample" name="pyksample"  class="pyksample rd" required  value=""  /></td>
                   
                </tr>
                <tr>
                    <td></td>
                    <td></td>
                    <td><input type="text" id="pykwater2" name="pykwater2" class="pykwater rd"  required value="" tabindex="4"/>
                    <td><input type="text" id="pyksample2" name="pyksample2"  class="pyksample rd" required value=""/></td>
                    
                </tr>
                <tr class="tg-even">
                    <td></td>
                    <td></td>
                    <td><input type="text" id="pykwater" name="pykwater3" class="pykwater rd"  required value="" tabindex="6"/></td>
                    <td><input type="text"  id="pyksample3" name="pyksample3" class="pyksample rd" required  value="" /></td>
                    
                </tr>
<!--                <tr>
                    <td></td>
                    <td></td>
                    <td><input type="text" id="pykwater" name="pykwater4" class="pykwater rd"  required value="" tabindex="8"/></td>
                    <td><input type="text" id="pyksample4" name="pyksample4" class="pyksample rd"  required value=""  /></td>
                  
                </tr>-->
                <tr class="tg-even">
                    <td></td>
                    <td>MEAN:</td>
                    <td><input type="text" id="meanofwater" name="meanofwater"   class="meanofwater rd" readonly="readonly" value=""  /></td>
                    <td><input type="text" id="meanofsample" name="meanofsample" class="meanofsample rd"  readonly="readonly" value=""/></td>
          ...
          <div id="massses">
              ...
              <tr>
                  <td>
                      ...
                      <td><input type="text" id="maw" name="maw" class="maw "  readonly="readonly" value=""/>
                  </td>
              </tr>
                 <tr>
                  <td>
                      <label>Mass of Sample (g): </label></td>
                      <td><input type="text" id="mos" name="mos" class="mos "  readonly="readonly" value=""/>
                  </td>
                 </tr>
                   <tr>
                  <td>
                      <label>Sample Relative Density: </label></td>
                      <td><input type="text" id="srd" name="srd" class="srd "  readonly="readonly" value=""/>
                  </td>
              </tr>
              </table>

                </div>
             <p><input type="button" value="Save Relative Density Data" id="Save"/></p>
            </div>
    </center>
</form>
<script>
    $(document).ready(function() {
        ...
        $('#Save').click(function() {
            var bad = 0;
            $('#RdForm .rd').each(function()
            {
                if ($.trim(this.value) === "" || $.trim(this.value) === "NaN")
                    bad++;
            });
            if (bad > 0) {
                $.prompt(bad + ' compulsory field(s) has/have not been filled ');
            }
            else {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url(); ?>relativity/save/<?php echo $labref.'/'.$test_id; ?>",
                                        data: dataString2,
                                        success: function() {
											window.location.href="<?php echo base_url();?>analyst_controller";
                                            $('#Save').prop('value', 'Save Relative Density Data');
