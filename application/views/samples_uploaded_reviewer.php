...
<script type="text/javascript" src="<?php echo base_url();?>javascripts/js/jquery.min.js" ></script> 
		...
		<script type="text/javascript" charset="utf-8">
			$().ready(function() {
				var elf = $('#elfinder').elfinder({
					url : '<?php echo base_url();?>Reviewer_uploads/elfinder_init/'  // connector URL (REQUIRED)
                                        
					// lang: 'ru',             // language (OPTIONAL)
				}).elfinder('instance');
                                    elFinder.prototype.options.option1 = "Home";
