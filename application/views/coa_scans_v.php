...
$('#labref').change(function(){
	labref = $(this).val();
	$.getJSON("<?php echo base_url().'coa_scans/coa_number/';?>"+labref,function(resp){
		console.log(resp[0].CAN);
		$('#title').val(resp[0].CAN);
	});
...
<html>
    ...
    <body>
        ...
        <form method="post" action="" id="upload_file">
            ...
            <select  name="labref" id="labref" selected="selected">
			<option value="">--Select Labref--</option>
			<?php foreach($req as $la):?>
			<option value="<?php echo $la->request_id;?>"><?php echo $la->request_id;?></option>
			<?php endforeach;?>
			</select>
