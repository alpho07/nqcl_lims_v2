...
<tr><td>Request ID</td><td><input type="text" name="lab_ref_no" id="lab_ref_no" <?php if ($issuance_status[0]['count'] > 0){ echo "readonly";} ?> value="<?php echo $request[0]['request_id'] ?>" /></td></tr>
<tr><td>Quotation/PLO No.</td><td><input type="text" name="lab_ref_no"  value="<?php echo $request[0]['quotation'] ?>" /></td></tr>
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status === "success") {					
						...
						window.location.href = "<?php echo base_url().'request_management/edit_1/'.$labref; ?>";
