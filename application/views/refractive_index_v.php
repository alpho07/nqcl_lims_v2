...
<form name="" action="" method="post" id="pHform">
    <center>
        <div class="uniformity">
            ...
            <legend><h4>&#8801; NQCL &#187; REFRACTIVE INDEX MEASUREMENT &#187; SAMPLE : <?php echo $labref; ?> </h4></legend>
            <hr>
            <p></p>
            <h3>Outline Sample Preparation Procedure</h3>
            <hr>
            <div id="comments_area">
                <textarea id="comments" cols="100" rows="5" name="comments" required="readonly" class="phd"></textarea>
            </div>
            <p>
            ...
            <table class="tg-table-light">
                ...
                <tr class="tg-even">
                    <td>1</td>
                    <td><input type="text" id="ph1" name="ph1"  class="ph phd" required value="" tabindex="1"/></td>

                </tr>
                <tr>
                    <td>2</td>

                    <td><input type="text" id="ph2" name="ph2" class="ph phd"  required value="" tabindex="2"/>

                </tr>

                <tr class="tg-even">
                    <td>3</td>                   
                    <td><input type="text" id="ph3" name="ph3"   class="ph phd" required value=""  /></td>                   
                </tr> 
                <tr class="">
                    <td>4</td>                   
                    <td><input type="text" id="ph4" name="ph4"   class="ph phd" required value=""  /></td>                   
                </tr> 
                <tr class="tg-even">
                    <td>MEAN</td>                   
                    <td><input type="text" id="phmean" name="phmean"   class="phmean" readonly value=""  /></td>                   
                </tr>             
            </table>
            ...
            <div id="massses">
                <table>
                    <tr>
                        ...
                        <td><input type="text" id="phmeanc" name="sampleph" class="phmean"  readonly="readonly" value=""/>
                        </td>
                    </tr>
            ...
            <p><input type="button" value="Save Refractive Index Data" id="Save"/></p>
    ...
    $(document).ready(function() {
        ...
        $('#Save').click(function() {
            ...
            if (bad > 0) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url(); ?>refractivity/save/<?php echo $labref.'/'.$test_id; ?>",
                                        data: dataString2,
                                        success: function() {
                                            $('#Save').prop('value', 'Save Refractive Index Data');
