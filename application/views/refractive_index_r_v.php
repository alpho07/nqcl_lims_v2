...
<?php echo form_open('refractivity/approve/'.$labref.'/'.$r.'/'.$c); ?>
    <center>
        <div class="uniformity">
            <legend>  &#171; <?php echo anchor('supervisors/home/' . $labref, 'Back') ?></legend>
            <legend><h4>&#8801; NQCL &#187; RESULTS FOR REFRACTIVE INDEX MEASUREMENT &#187; SAMPLE : <?php echo $labref; ?> </h4></legend>
            <hr>
            ...
            <hr>
            <p></p>
            <h3>Determination of Refractive Index:</h3>
            <hr>
            <table class="tg-table-light">
                <tr>
                    <th>No</th>
                    <th>Sample Readings</th>                                  

                </tr>
                <tr class="tg-even">
                    <td>1</td>
                    <td><input type="text" id="ph1" name="ph1_r"  class="ph phd" readonly value="<?php echo $ph_top[0]->sample_readings; ?>" tabindex="1"/></td>

                </tr>
                <tr>
                    <td>2</td>

                    <td><input type="text" id="ph2" name="ph2_r" class="ph phd"  readonly value="<?php echo $ph_top[1]->sample_readings; ?>" tabindex="2"/>

                </tr>

                <tr class="tg-even">
                    <td>3</td>                   
                    <td><input type="text" id="ph3" name="ph3_r"   class="ph phd" readonly value="<?php echo $ph_top[2]->sample_readings; ?>"  /></td>                   
                </tr> 
                <tr class="">
                    <td>4</td>                   
                    <td><input type="text" id="ph4" name="ph4_r"   class="ph phd" readonly value="<?php echo $ph_top[3]->sample_readings; ?>"  /></td>                   
                </tr> 
                <tr class="tg-even">
                    <td>MEAN</td>                   
                    <td><input type="text" id="phmean" name="phmean_r"   class="phmean" readonly value="<?php echo $ph_bottom[0]->mean; ?>"  /></td>                   
                </tr>             
            </table>
            ...
            <div id="massses">
                <table>
                    <tr>
                        <td>
                            <label>Refraction Index of the Sample  : </label></td>
                        <td><input type="text" id="phmeanc" name="sampleph_r" class="phmean"  readonly="readonly" value="<?php echo $ph_bottom[0]->refractive_index; ?>"/>
                        </td>
                    </tr>
