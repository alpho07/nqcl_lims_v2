...
$('#sendit').click(function() {
    ...
    $.ajax({
        type: 'post',
        url: '<?php echo base_url() . 'assay_suspension/postRepeatReason/' . $labref; ?>',
        data: data,
 ...
 $('#dialog').trigger('close');
       ...
       $(this).prop('disabled', 'disabled');
        substance=$('#activeIngredient').val();
            $.ajax({
                    type: "GET",
                    url: "<?php echo base_url(); ?>assay_suspension/check_done/<?php echo $labref; ?>/" + substance,
                    dataType: "json",
                    success: function(data) {
...
function loadComponents() {
    ...
    $.ajax({
        type: "GET",
        url: "<?php echo base_url(); ?>assay_suspension/loadComponents/<?php echo $labref; ?>",
                        dataType: "json",
                        success: function(data) {
                            if (data == "5") {
                              ...
                              active=$('#activeIngredient').find('option').first().val();
                                $('#comp').val(active);
                                $('#labelclaim').val(data[0].volume1).trigger('change');
                                $('#volume').val(data[0].volume2).trigger('change');
...
$.ajax({
    type: "GET",
    url: "<?php echo base_url(); ?>assay_suspension/loadRepeatComponents/<?php echo $labref; ?>",
                    dataType: "json",
                    success: function(data) {
    ...
    $.ajax({
        ...
        url: "<?php echo base_url(); ?>assay_suspension/save_assay_multiple/<?php echo $labref.'/'.$test_id; ?>",
                ...
                function repeat() {
                    ...
                    $.ajax({
                        type: "GET",
                        url: "<?php echo base_url(); ?>assay_suspension/loadComponents_lc/<?php echo $labref; ?>/" + select,
                        dataType: "json",
                        success: function(data) {
...
<!--    <div class="refsub">
    ...
    <div id="middle_assay">
            <div id="sampleassay">
                ...
                <center><h3>Sample</h3></center>
                        ...
                        <tr>
                            ...
                            <td>
                              Contains
                                ...
                                mg of <span id="component"><input type="text" id="comp" style="width: 150px;" readonly/></span>
                    </td>
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                <label for="tabs_caps_average">Relative Density: </label>
                                <input type="text" name="" value="Select RD" id="tabs_caps_average" style="position: absolute; margin-left: 0px; width: 103px; font-size: 12px;"/>
                                <select name="tabs_caps_average" id="tabs_caps_average1" style="width:127px;">
                     
                        <option value="1">Not Available</option>
                        <?php foreach ($rd as $d): ?>                    
                            <?php echo '<option value=' . $d->relative_density . '>' . $d->relative_density . '</option>'; ?>                    
                        <?php endforeach; ?>
                          </select>
                    </td>
                ...
                <input type="hidden" value="1" name="mwsalt"/>
                <input type="hidden" value="1" name="mwbase"/>
...
<!--                            <th>LC(mg)</th>		-->
                        ...
                        <tr>
                            <td class="weight" ><strong><br></br></strong></td>
                            ...
                            <td class="vf3head4"><select name="pipette3" id="pipette3" required value="1">
                                ...
                                <td class="vf3head4" style=""><select name="vf41" id="vf41" required value="1">
                                    <option value="1"></option>
                                    <option value="5">5</option>
                                    <option value="10">10</option>
                                    <option value="20">20</option>
...
<!--                            <td class="mgml"><input type="text" name="labelclaim" placeholder="0.04mg/ml" id ="labelclaim" value="" required  /></td>-->
                        ...
                        <tr>
                            <td colspan="9" class="weight" ><span style="margin-left: 40px;"><strong>Weight taken </strong></span></td>
                        <tr>
                            <td class="weight" ><strong> A &rarr;</strong></td>
...
<!--                        &nbsp;&nbsp;&nbsp;&nbsp;<input type="button" id="Export_r" value="Save & Repeat" class=""/><br />-->
            ...
            <script type="text/javascript" src="<?php echo base_url(); ?>javascripts/assay.min_suspension.js"></script>
