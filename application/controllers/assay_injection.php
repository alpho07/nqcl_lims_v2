...
class Assay_injection extends MY_Controller {
    ...
    ,'{$v['vf4']}','{$v['concetration']}','{$v['repeat_status']}','{$v['analyst_id']}')";
        ...
        if ($dosageForm == "9") {
            $file1 = "original_workbook/Powder_for_injection.xlsx";
        } else {
            $file1 = "original_workbook/Injection.xlsx";
        }
        ...
        $worksheet = $objPHPExcel->getActiveSheet()
                ...
                ->setCellValue('D43', $this->input->post('u_weight_c'))

                //->setCellValue('A36', 'Standard B')
                ->setCellValue('F43', $this->input->post('u_weight1_c'))


                //  ->setCellValue('B59', $this->input->post('aiweight'))
                ->setCellValue('B58', $this->input->post('svf1'))
                ->setCellValue('B59', $this->input->post('sp1'))
                ->setCellValue('B60', $this->input->post('svf2'))
                ->setCellValue('B61', $this->input->post('pipette2'))
                ->setCellValue('B62', $this->input->post('vf3'))
                ->setCellValue('B63', $this->input->post('pipette3'))
                ->setCellValue('D64', $this->input->post('vf41'))
        ...
        $objPHPExcel->getActiveSheet()->setTitle('AI_' . $component1);
        $dir = "workbooks";
