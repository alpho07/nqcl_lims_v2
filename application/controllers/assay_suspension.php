...
class Assay_suspension extends MY_Controller {
    ...
    ,'{$v['vf4']}','{$v['concetration']}','{$v['repeat_status']}','{$v['analyst_id']}')";
       ...
       // echo $worksheetIndex = $data[0]->no_of_sheets;
        ...
        $file1 = "original_workbook/Suspension.xlsx";
         ...
         $worksheet=  $objPHPExcel->getActiveSheet()
               ...
               //  ->setCellValue('B59', $this->input->post('aiweight'))
                   ...
                   // ->setCellValue('D66', $this->input->post('smgml'))
                    ...
                    ->setCellValue('D61', $this->input->post('sampleA'))           
                   
                    ->setCellValue('D65', $this->input->post('sampleB'))
                    ->setCellValue('D69', $this->input->post('sampleC'))
...
$objPHPExcel->getActiveSheet()->setTitle('AS_'.$component1);
            $dir = "workbooks";
