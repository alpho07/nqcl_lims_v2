...
class Sample_Controller extends MY_Controller{
	...
	public function update(){
		...
		//$valid = true;
		if($valid == false){
			$data['settings_view'] = "sample_edit_v";
			$this -> base_params($data);
		}else{	
	...
	public function edit(){
		...
		$data['mylist'] =Request::getAll5($reqid);
		$data['clientinfo'] =Clients::getClient2($reqid);
		$data['sampleinfo'] = Sample_information::getLabRef($reqid);
		$data['title'] = "Edit Sample Information";
     	$data['content_view'] = "sample_edit_v";
		$data['banner_text'] = "Sample Information";
		$data['link'] = "home";
		$data['quick_link'] = "sample_edit_v";
