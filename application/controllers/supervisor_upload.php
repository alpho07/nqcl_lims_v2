...
class Supervisor_Upload extends MY_Controller {
    ...
    function worksheet() {
        ...
        $data['error'] = '';
        $data['settings_view'] = 'upload_analyst_v_2';
      ...
      //  exit();
        ...
        if (file_exists($filename)) {
            ...
            if (!$this->upload->do_upload('worksheet')) {
                ...
                $this->setDoneIdSupervisor($labref);
