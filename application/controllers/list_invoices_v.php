...
<script type="text/javascript">
	...
	$(function(){
		...
		var childTable= $('#list_quotation_child<?php echo $quotation_no;?>').DataTable({
			"order":[[3,'asc']],
			"aoColumns": [
			{"sTitle":"Quotation Id.","mData":"Quotations_id",
			...
			{"sTitle":"Amount (<?php echo $currency; ?>)","mData":"Amount",
				"mRender": function (data, type, row) {
		...
		//Add Reference to Quotation
		 ...
		 $('#list_quotation_child<?php echo $quotation_no;?> tbody').on("click", "td.viewQuotationEntry", function (e) {
			...
			e.preventDefault();
            var href = '<?php echo base_url() . "client_billing_management/showBillPerTest/" ?>'+quotation_no+'/quotations/tests/q_request_details/q_entry';
