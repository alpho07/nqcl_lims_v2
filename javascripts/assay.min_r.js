...
$(document).ready(function(){
    $('#workingvf2,#workingvf1,#workingnumber,#workingmgml,#workingp1,#workingp2, #workingvf3,#workingp3,#workingvf4').change('live',function() {
        var answer=0;  
             
        
        var mgml=parseFloat($('#workingnumber').val());               
        ...
        answer=((mgml/a)*(b/c)*(d/e)*(f/g));
               
        $('#workingmgml').val(answer.toFixed(6));
        $('#smgml').val(answer.toFixed(6));
