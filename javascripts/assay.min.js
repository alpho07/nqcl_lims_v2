...
$(document).ready(function()
{
        ...
        $("#workingvf1,#workingp1,#workingvf2,#workingp2,#workingvf3,#workingp3,#workingvf4").change(function()
        {
            ...
            $('#number,#vf1,#p1,#vf2,#p2,#vf31,#p321,#vf32,#number1,#vf11,#p11,#vf22,#ppt1,#vf33,#ppt2,#vf34,#workingvf1,#workingp1,#workingvf2,#workingp2,#workingvf3,#workingp3,#workingvf4').change('live',function() {
